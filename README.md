...
pnpm --filter @sdlc-code/core design-phase:smoke "Build a todo app"  # System Design + UI Design, drawn in Penpot
pnpm --filter @sdlc-code/core penpot:smoke                 # Penpot only: draws a fixed UI Spec and exports PNGs
